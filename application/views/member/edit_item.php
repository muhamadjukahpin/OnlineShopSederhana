...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        <input type="number" name="no_hp" id="no_hp" class="form-control" value="<?= substr($item['no_hp'], 2); ?>">
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="number" class="form-control" id="weight_item" name="weight_item" value="<?= $item['weight_item']; ?>">
                    </div>
                    <div class="col-md-3">
        ...
        <div class="col-md-4">
            ...
            <input type="hidden" id="province" name="province" value="<?= $item['province']; ?>">
            <div class="form-group">
            ...
            <input type="hidden" id="city_name" name="city_name" value="<?= $item['city']; ?>">
